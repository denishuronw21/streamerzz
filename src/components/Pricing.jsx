                ...
                {PLANS_CONTENT.plans.map((plan,index)=>(
                    ...
                    className={`bg-neutral-950 p-8 rounded-xl shadow-lg
                        ${
                            ...
                            <h3 className='text-lg lg:text-xl mb-4 tracking-tighter uppercase'>{plan.name}</h3>
                            ...
                            <button className='w-full py-3 px-4 bg-blue-600 hover:bg-blue-500 rounded-lg'>{PLANS_CONTENT.ctaText}</button>
                        </motion.div>
                ))}
